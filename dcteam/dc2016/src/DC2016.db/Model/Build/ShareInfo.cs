...
namespace DC2016.Model {
	...
	public partial class ShareInfo {
		...
		#region 独创的序列化，反序列化
		protected static readonly string StringifySplit = "@<Share(Info]?#>";
		...
		public ShareInfo(string stringify) {
			string[] ret = stringify.Split(new char[] { '|' }, 13, StringSplitOptions.None);
			if (ret.Length != 13) throw new Exception("格式不正确，ShareInfo：" + stringify);
		...
		private void Init__jsonIgnore() {
			if (__jsonIgnore == null) {
				lock (__jsonIgnore_lock) {
					if (__jsonIgnore == null) {
						FieldInfo field = typeof(ShareInfo).GetField("JsonIgnore");
		...
		public override bool Equals(object obj) {
			ShareInfo item = obj as ShareInfo;
		...
		public static bool operator ==(ShareInfo op1, ShareInfo op2) {
		...
		public DC2016.DAL.Share.SqlUpdateBuild UpdateDiy {
			get { return DC2016.BLL.Share.UpdateDiy(this, _Id); }
		}
	}
}
