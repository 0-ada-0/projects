...
{
	gate:'mf',//产品代号，必选参数
	number:'',//帐号number编号，可不传
	email:'940235644@qq.com',//邮箱帐号，必选参数
	pstype:'game',//操作类型，一般是game
	lang:'',//语言，可选参数
	ip:'127.0.0.1'//必选参数
};
...
var paramskey=new Array('gate','email','number','pstype','lang','ip');//该数组是接口所有请求参数
var path = "/urs/get_pwd_by_mail";
