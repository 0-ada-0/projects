...
namespace DC2016.Model {
	...
	public partial class Raffle_info_tblInfo {
		#region fields
		private uint? _Id;
		...
		public Raffle_info_tblInfo() { }

		#region 独创的序列化，反序列化
		protected static readonly string StringifySplit = "@<Raffle_info_tbl(Info]?#>";
		...
		public Raffle_info_tblInfo(string stringify) {
			string[] ret = stringify.Split(new char[] { '|' }, 7, StringSplitOptions.None);
			if (ret.Length != 7) throw new Exception("格式不正确，Raffle_info_tblInfo：" + stringify);
		...
		private void Init__jsonIgnore() {
			if (__jsonIgnore == null) {
				lock (__jsonIgnore_lock) {
					if (__jsonIgnore == null) {
						FieldInfo field = typeof(Raffle_info_tblInfo).GetField("JsonIgnore");
		...
		public override bool Equals(object obj) {
			Raffle_info_tblInfo item = obj as Raffle_info_tblInfo;
		...
		public static bool operator ==(Raffle_info_tblInfo op1, Raffle_info_tblInfo op2) {
		...
		public DC2016.DAL.Raffle_info_tbl.SqlUpdateBuild UpdateDiy {
			get { return DC2016.BLL.Raffle_info_tbl.UpdateDiy(this, _Id); }
		}
	}
}
