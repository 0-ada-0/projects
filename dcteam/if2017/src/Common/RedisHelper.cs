...
namespace IF2017.Common
{

	public static partial class RedisHelper {
		public static List<TReturnInfo> ToList<TReturnInfo>(this SelectBuild<TReturnInfo> select, int expireSeconds) { return select.ToList(RedisHelper.Get, RedisHelper.Set, TimeSpan.FromSeconds(expireSeconds)); }
		public static List<TReturnInfo> ToList<TReturnInfo>(this SelectBuild<TReturnInfo> select, TimeSpan expire) { return select.ToList(RedisHelper.Get, RedisHelper.Set, expire); }

		public static string ConnectionString = "";
		public static ConnectionMultiplexer NewConnection() {
			if (string.IsNullOrEmpty(ConnectionString)) {
				string key = "IF2017RedisConnectionString";
